    ...
    return (
      <div className='flex h-screen items-center justify-center bg-gray-100'>
        <form onSubmit={handleLogin} className='bg-white p-8 rounded shadow-md w-96'>
          ...
          <label className='block text-sm font-medium text-gray-700 mb-1'>Organization ID (Slug)</label>
          <input className='w-full border p-2 mb-4 rounded focus:ring-2 focus:ring-blue-500 outline-none' 
            placeholder='e.g., cyber' value={slug} onChange={e => setSlug(e.target.value)} required />
          <label className='block text-sm font-medium text-gray-700 mb-1'>Admin Email</label>
          <input className='w-full border p-2 mb-4 rounded focus:ring-2 focus:ring-blue-500 outline-none' 
            placeholder='admin@cyber.com' value={email} onChange={e => setEmail(e.target.value)} required />
          <label className='block text-sm font-medium text-gray-700 mb-1'>Password</label>
          <input className='w-full border p-2 mb-6 rounded focus:ring-2 focus:ring-blue-500 outline-none' 
